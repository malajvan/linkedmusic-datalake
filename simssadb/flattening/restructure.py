...
cols = ['musical_work_id','musical_work_variant_titles','contributor_role', 'genre_style', 'file_format','url_to_file', 'Last_Pitch_Class','contributor_given_name', 'contributor_sur_name']
df2 = df[cols]
...
merge_on = ["musical_work_id",'musical_work_variant_titles','composer', 'genre_style']
