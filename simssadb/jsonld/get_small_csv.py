...
cols = ['musical_work_id','musical_work_variant_titles','contributor_role','contributor_full_name','contributor_auth_url','contributor_viaf_id', 'genre_style', 'file_format','url_to_file', 'Last_Pitch_Class']
df2 = df[cols]
